...
curl 'http://localhost:8091/documents?search=your+query&limit=5'
```
...
curl http://localhost:8091/tools?mode=full
...
|----------|---------|----------|
| [PROGRESSIVE-DISCLOSURE-IMPLEMENTATION.md](PROGRESSIVE-DISCLOSURE-IMPLEMENTATION.md) | Implementation summary | Developers |
...
All endpoints available at `http://localhost:8091/discovery/*`
...
client = Client("http://localhost:8091")
...
class SmartAgent:
    def __init__(self):
        self.base = "http://localhost:8091"
        self.hybrid = "http://localhost:8092"
...
- **Implementation Details**: [PROGRESSIVE-DISCLOSURE-IMPLEMENTATION.md](PROGRESSIVE-DISCLOSURE-IMPLEMENTATION.md)
...
2. Review [AI-SYSTEM-TEST-REPORT-2025-12-22.md](AI-SYSTEM-TEST-REPORT-2025-12-22.md) for known issues
3. Check service health: `curl http://localhost:8091/health`
