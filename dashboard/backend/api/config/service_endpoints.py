...
OTEL_COLLECTOR_HEALTH_PORT = _parse_port("OTEL_COLLECTOR_HEALTH_PORT", 13133)
NIXOS_DOCS_PORT = _parse_port("NIXOS_DOCS_PORT", 8096)
...
OTEL_COLLECTOR_HEALTH_URL = os.getenv(
    "OTEL_COLLECTOR_HEALTH_URL",
    f"http://{SERVICE_HOST}:{OTEL_COLLECTOR_HEALTH_PORT}",
)
NIXOS_DOCS_URL = os.getenv("NIXOS_DOCS_URL", f"http://{SERVICE_HOST}:{NIXOS_DOCS_PORT}")
RALPH_URL = os.getenv("RALPH_URL", f"http://{SERVICE_HOST}:{RALPH_PORT}")
AIDER_WRAPPER_URL = os.getenv("AIDER_WRAPPER_URL", f"http://{SERVICE_HOST}:{AIDER_WRAPPER_PORT}")
