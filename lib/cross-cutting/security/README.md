...
# Source the scanner
source lib/cross-cutting/security/scanner.sh
...
python3 lib/cross-cutting/security/audit-logger.py \
  --action log \
...
# Query events
python3 lib/cross-cutting/security/audit-logger.py --action query --limit 10

# Get statistics
python3 lib/cross-cutting/security/audit-logger.py --action stats
```
...
source lib/cross-cutting/security/compliance-checker.sh
...
source lib/cross-cutting/security/security-workflow-validator.sh
...
```bash
# Source hooks system
source lib/l1-infra/deploy/deployment-hooks.sh
