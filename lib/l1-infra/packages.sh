...
#   - lib/cross-cutting/common.sh → run_as_primary_user() function
#   - lib/l2-runtime/python.sh → ensure_python_runtime() function
#
# Required Variables:
...
#
# Note: This module mirrors helpers from lib/cross-cutting/common.sh but keeps them isolated
...
# ============================================================================
# NOTE: ensure_package_available() is defined in lib/cross-cutting/common.sh (canonical location).
# Duplicate removed in Phase 17.2.2 — common.sh is loaded after packages.sh and provides
# the definitive implementation.

# NOTE: ensure_prerequisite_installed() is defined in lib/cross-cutting/common.sh (canonical location).
