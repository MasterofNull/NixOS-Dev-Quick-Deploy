...
register_builtin_security_hooks() {
  local security_lib_dir="${REPO_ROOT}/lib/cross-cutting/security"
...
source "${REPO_ROOT}/lib/cross-cutting/security/security-workflow-validator.sh"
...
python3 "${REPO_ROOT}/lib/cross-cutting/security/audit-logger.py" \
  --action log \
