        ...
        content: (
          {
            ...
            install_hint: ("python /home/hyperd/.codex/skills/.system/skill-installer/scripts/deploy/install-skill-from-github.py --repo openai/skills --path skills/.curated/" + .name)
          } | tojson
        )
      }
