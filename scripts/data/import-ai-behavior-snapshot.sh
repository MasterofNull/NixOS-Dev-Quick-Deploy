#!/usr/bin/env bash
# scripts/data/import-ai-behavior-snapshot.sh
#
...
#
# Usage:
#   bash scripts/data/import-ai-behavior-snapshot.sh
#   POSTGRES_HOST=other-host bash scripts/data/import-ai-behavior-snapshot.sh
