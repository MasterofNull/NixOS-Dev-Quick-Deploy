...
usage() {
  cat <<'EOF'
Usage: ./scripts/deploy/recovery-iso-disk-fix.sh [options]
...
log "   NIX_EVAL_TIMEOUT_SECONDS=300 ./scripts/deploy/deploy-clean.sh --host nixos --profile ai-dev --skip-health-check"
