...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dashboard-phase5-7-") as tmp_dir:
        ...
        assert_true('id="hybridProgressiveLoads"' in html, "dashboard should expose progressive disclosure loads metric")
        assert_true('id="hybridCapabilityGaps"' in html, "dashboard should expose capability gap metric")
        assert_true('id="hybridLearningEvents"' in html, "dashboard should expose real-time learning metric")
        assert_true('id="hybridMetaAdaptations"' in html, "dashboard should expose meta-learning metric")
        ...
        assert_true('id="hybridAdaptiveSummary"' in html, "dashboard should render adaptive runtime summary")
        ...
        assert_true("document.getElementById('hybridProgressiveLoads').textContent" in html, "dashboard should populate progressive disclosure loads")
        assert_true("document.getElementById('hybridCapabilityGaps').textContent" in html, "dashboard should populate capability gaps")
        assert_true("document.getElementById('hybridLearningEvents').textContent" in html, "dashboard should populate learning events")
        assert_true("document.getElementById('hybridMetaAdaptations').textContent" in html, "dashboard should populate meta-learning adaptations")
        ...
        assert_true("Phase 8-10 Adaptive Runtime" in html, "dashboard should label adaptive runtime summary")
