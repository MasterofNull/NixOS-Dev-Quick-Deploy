...
REQUIRED_SNIPPETS = [
    ...
    'id="deploymentExecuteStrategy"',
    'id="deploymentCanaryPercentage"',
    'id="deploymentRollbackThreshold"',
    'id="deploymentExecuteDryRun"',
    'id="deploymentRequireApproval"',
    'id="deploymentExecutionSummary"',
    'id="deploymentPendingApprovalsList"',
    ...
    'function openDeploymentSearchInsight()',
    ...
    'function loadPendingDeploymentApprovals()',
