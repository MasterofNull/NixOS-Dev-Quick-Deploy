#!/usr/bin/env bash
# Test: aq-ctx-freshness — verifies the staleness check, --heal-shallow (background unshallow +
# AQ_UNSHALLOW_DEPTH), background/depth handling, and fail-safe (never hard-errors / blocks).
