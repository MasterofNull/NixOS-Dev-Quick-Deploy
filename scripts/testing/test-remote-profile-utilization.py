...
def main() -> int:
    ...
    entries = [
        ...
        },
        {
            ...
            "metadata": {
                ...
                "local_inference_lane_reason": "continuation_reasoning_lane",
    ...
    assert_true(
        any(item.get("label") == "local_lane_reason:continuation_reasoning_lane" for item in breakdown),
        "expected local inference lane reason breakdown",
    )
    assert_true(
