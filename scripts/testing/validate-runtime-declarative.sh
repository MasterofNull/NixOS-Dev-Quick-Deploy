...
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/core/session_builders.py" "AI_RUN_DEFAULT_SAFETY_MODE"
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/workflow/runtime_manager.py" "RUNTIME_SAFETY_POLICY_FILE"
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/workflow/runtime_manager.py" "RUNTIME_ISOLATION_PROFILES_FILE"
