...
need_file "${ROOT}/scripts/automation/post-deploy-converge.sh"
need_pattern "${ROOT}/scripts/automation/post-deploy-converge.sh" "hints_feedback_endpoint_probe"
need_pattern "${ROOT}/scripts/automation/post-deploy-converge.sh" "tool_audit_seed"
...
need_pattern "${ROOT}/scripts/automation/post-deploy-converge.sh" "aq_auto_remediation"
need_pattern "${ROOT}/scripts/automation/post-deploy-converge.sh" "intent_remediation_bounded"
need_pattern "${ROOT}/scripts/automation/post-deploy-converge.sh" "hint_adoption_remediation_bounded"
...
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/session_builders.py" "AI_RUN_DEFAULT_SAFETY_MODE"
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/runtime_manager.py" "RUNTIME_SAFETY_POLICY_FILE"
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/runtime_manager.py" "RUNTIME_ISOLATION_PROFILES_FILE"
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/agent_registry.py" "WORKFLOW_BLUEPRINTS_FILE"
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/runtime_manager.py" "RUNTIME_SCHEDULER_POLICY_FILE"
need_pattern "${ROOT}/ai-stack/mcp-servers/hybrid-coordinator/runtime_manager.py" "PARITY_SCORECARD_FILE"
