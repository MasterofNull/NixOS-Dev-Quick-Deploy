...
#
# Usage:
#   scripts/governance/apply-project-root.sh path/to/file [path/to/file ...]
#   scripts/governance/apply-project-root.sh --project-root /path/to/repo --user alice --uid 1000 file...
#
set -euo pipefail
...
usage() {
  cat <<'USAGE'
Usage: scripts/governance/apply-project-root.sh [options] <file> [file...]
