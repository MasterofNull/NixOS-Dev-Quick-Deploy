...
# Add repository root to path for local aidb imports.
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "ai-stack" / "mcp-servers" / "aidb"))
...
Examples:
  ...
  ./record-issue.py "Deployment failed" "P1 features failed to deploy" \\
    ...
    try:
        ...
        print(f"   Analyze patterns: ./scripts/governance/analyze-issues.py")
