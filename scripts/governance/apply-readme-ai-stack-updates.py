...
./scripts/ai/ai-stack-manage.sh up         # Start AI services
./scripts/ai/ai-stack-manage.sh health     # Check health
```
...
**Manage AI services:**
```bash
./scripts/ai/ai-stack-manage.sh up         # Start all AI services
./scripts/ai/ai-stack-manage.sh down       # Stop all AI services
./scripts/ai/ai-stack-manage.sh restart    # Restart AI stack
./scripts/ai/ai-stack-manage.sh status     # Show service status
./scripts/ai/ai-stack-manage.sh logs       # View all logs
./scripts/ai/ai-stack-manage.sh logs aidb  # View specific service logs
./scripts/ai/ai-stack-manage.sh health     # Run health checks
./scripts/ai/ai-stack-manage.sh sync       # Sync documentation to AIDB
```
