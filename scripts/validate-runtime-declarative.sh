...
need_file "${ROOT}/scripts/aq-auto-remediate.py"
need_file "${ROOT}/scripts/run-intent-remediation-bounded.sh"
need_file "${ROOT}/scripts/run-hint-adoption-remediation-bounded.sh"
need_file "${ROOT}/scripts/seed-tool-audit-traffic.sh"
need_file "${ROOT}/scripts/check-routing-fallback.sh"
