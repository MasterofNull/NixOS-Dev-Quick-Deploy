      ...
      systemd.services.ai-hybrid-coordinator = {
        ...
        serviceConfig = commonServiceConfig // {
          ...
          Environment = [
            ...
            "AI_TOOL_SECURITY_CACHE_TTL_HOURS=${toString ai.aiHarness.runtime.toolSecurity.cacheTtlHours}"
            "RUNTIME_TOOL_SECURITY_POLICY_FILE=${runtimeToolSecurityPolicyJson}"
            "AI_CODE_EXEC_TOOLING_MANIFEST_ENABLED=${if ai.aiHarness.runtime.codeExecution.enable then "true" else "false"}"
            ...
            "AI_BROWSER_RESEARCH_ENABLED=${if ai.aiHarness.runtime.browserResearch.enable then "true" else "false"}"
            ...
            "AI_BROWSER_RESEARCH_CHROMIUM_BIN=${if ai.aiHarness.runtime.browserResearch.chromiumBinary == "chromium" then lib.getExe pkgs.chromium else ai.aiHarness.runtime.browserResearch.chromiumBinary}"
            ...
            "AI_LOCAL_FRONTDOOR_ROUTING_ENABLE=${if ai.aiHarness.runtime.localFrontdoorRouting.enable then "true" else "false"}"
      ...
      systemd.services.ai-aider-wrapper = {
        ...
        serviceConfig = commonServiceConfig // {
          ...
          Environment = [
            ...
            "AI_AIDER_AUTO_FILE_SCOPE=${if ai.aiHarness.runtime.aiderAutoFileScope then "true" else "false"}"
