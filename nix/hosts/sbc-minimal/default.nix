...
Imports facts.nix when present and applies SBC-specific overrides on top of
the common module stack.  Hardware-configuration.nix is included when present
(generated by nixos-generate-config on real hardware).
