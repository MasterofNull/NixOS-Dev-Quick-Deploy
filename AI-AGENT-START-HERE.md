...
4. **[Progressive Disclosure Guide](docs/03-PROGRESSIVE-DISCLOSURE.md)** (15 min)
...
|---------|-----|---------|--------------|
| **AIDB MCP** | http://localhost:8091 | Main API, skills, tools | `curl http://localhost:8091/health` |
| **Hybrid Coordinator** | http://localhost:8092 | Smart routing | `curl http://localhost:8092/health` |
| **Qdrant** | http://localhost:6333 | Vector database | `curl http://localhost:6333/healthz` |
...
1. **Quick health check**: `curl http://localhost:8091/health`
