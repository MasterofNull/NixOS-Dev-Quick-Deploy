...
- Current targeted branch-coverage baselines from the new runner are: `context_store 17.4%`, `route_handler 28.7%`, `ai_coordinator 37.0%`, and `advanced_features 51.9%`. These thresholds now guard against regression while broader line coverage still needs expansion.
