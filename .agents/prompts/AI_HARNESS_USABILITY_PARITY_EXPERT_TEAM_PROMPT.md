...
Follow the round wrapper's final output instruction exactly. For the active
`usability-parity-v2` round, Antigravity/Gemini must write only:

`.agents/plans/usability-parity-v2/antigravity.md`

Do not write to `.agents/plans/usability-parity/`; that was the superseded draft round.
...
`scripts/ai/aq-collaborate contribute plan-collab_1-1783573787 --agent <agent-id> --content "<proposal path or summary>" --confidence 0.8`
