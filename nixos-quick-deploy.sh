...
show_fresh_start_instructions() {
    ...
    echo "   cat ~/Documents/AI-Optimizer/NixOS-Quick-Deploy/RECOVERY-GUIDE.md"
    echo ""
    echo -e "${YELLOW}5. After fixing the issue, re-run deployment:${NC}"
    echo "   cd ~/Documents/AI-Optimizer/NixOS-Quick-Deploy"
...
print_post_install() {
    ...
    echo "     git clone <your-repo> ~/Documents/AI-Optimizer"
    echo "     cd ~/Documents/AI-Optimizer"
    echo ""
    ...
    echo "  • AIDB docs: ~/Documents/AI-Optimizer/README.md"
    echo "  • Shared knowledge: ~/Documents/AI-Optimizer/.aidb-shared-knowledge/"
