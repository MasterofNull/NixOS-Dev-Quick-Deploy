...
HYBRID_BASE_URL="${HYBRID_BASE_URL:-http://${SERVICE_HOST:-localhost}:8092}"
QDRANT_BASE_URL="${QDRANT_BASE_URL:-http://${SERVICE_HOST:-localhost}:6333}"
LLAMA_CPP_BASE_URL="${LLAMA_CPP_BASE_URL:-http://${SERVICE_HOST:-localhost}:8080}"
EMBEDDINGS_BASE_URL="${EMBEDDINGS_BASE_URL:-http://${SERVICE_HOST:-localhost}:8081}"
