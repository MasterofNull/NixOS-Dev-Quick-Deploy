...
# Default to overlay for compatibility with existing systems
# overlay works well on most filesystems with fuse-overlayfs for rootless
DEFAULT_PODMAN_STORAGE_DRIVER="${DEFAULT_PODMAN_STORAGE_DRIVER:-overlay}"
