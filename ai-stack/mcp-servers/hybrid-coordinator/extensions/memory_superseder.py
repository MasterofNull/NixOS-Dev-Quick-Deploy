"""
memory_superseder.py - temporal memory supersession surface.

This is the first Phase 55 implementation slice: a small, idempotent ledger and
HTTP contract for marking a fact as replaced by newer evidence. The actual AIDB
metadata mutation can deepen behind this surface without changing callers.
"""
