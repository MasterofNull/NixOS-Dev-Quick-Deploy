...
class Config:
    ...
    AI_HARNESS_EVAL_TIMEOUT_S = float(os.getenv("AI_HARNESS_EVAL_TIMEOUT_S", "90.0"))
    AI_HARNESS_EVAL_TIMEOUT_HARD_CAP_S = float(os.getenv("AI_HARNESS_EVAL_TIMEOUT_HARD_CAP_S", "45.0"))
