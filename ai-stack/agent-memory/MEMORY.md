...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: AQ-OS installer P0/P1 landing — inert verifier (closed key-ID/MAC), golden profile with AI-off-no-deps fix; P14s GL9750 microSD PIO workaround pending rebuild; local/Claude dispatch lifecycle gaps remain)
