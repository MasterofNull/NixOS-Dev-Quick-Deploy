...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: AQ-OS P0 schema coverage corrected; local/Claude dispatch lifecycle gaps remain; concurrent prompt evaluation can dirty the tracked registry; use the hook-exact full-index diff contract for review hashes)
