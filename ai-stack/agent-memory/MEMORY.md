...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: terminal dogfood receipt overwrite and managed-sandbox registry EROFS are active; prompt latency/budget drift remains measured; stale AQ-OS owner-gate wording is corrected)
