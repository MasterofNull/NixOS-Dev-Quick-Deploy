...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: mid-task llama reload recovery and active-tool-lease grammar parity are in flight; prompt latency/budget drift remains measured; stale AQ-OS owner-gate wording is corrected)
