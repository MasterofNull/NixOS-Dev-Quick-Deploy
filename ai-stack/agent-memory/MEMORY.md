...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: AQ-OS P0 verifier remains activation-blocked and uses a closed local key-ID/MAC contract; local/Claude dispatch lifecycle gaps remain; use the hook-exact full-index diff contract for review hashes)
