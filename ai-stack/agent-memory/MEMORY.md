...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: agent MCP native projection; open: connector OAuth, Continue completion latency, stale regression tests, MCP skill validator contract, `t3mp3st-runtime-attachment`)
