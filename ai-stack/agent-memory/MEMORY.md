...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: P14s GL9750 microSD DMA/ADMA corruption has a host-scoped PIO workaround pending rebuild validation; AQ-OS P0 verifier integration remains under clean-slice review)
