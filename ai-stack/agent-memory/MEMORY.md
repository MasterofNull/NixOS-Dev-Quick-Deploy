...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: suspend/resume governance and durable worktree checkpointing are active; Security Center lifecycle and redacted history findings need triage/rotation; local benchmark timeout blocks honest recalibration; P14s microSD PIO workaround needs reboot validation)
