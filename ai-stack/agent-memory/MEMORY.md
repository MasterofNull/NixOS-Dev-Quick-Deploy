...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: AQ-OS installer through P2b landed; Security Center lifecycle and redacted history findings need triage/rotation; local benchmark timeout blocks honest recalibration; P14s microSD PIO workaround needs reboot validation)
