...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: llama confinement activated; local prompt budgeting and dogfood shared-worktree isolation in independent review; readiness NSS denial and local-lane completion evidence remain follow-ups)
