...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: local rendered-prompt latency/budget drift, late invalid dogfood edit after timeout, and stale AQ-OS owner-gate classification are active; llama confinement is healthy)
