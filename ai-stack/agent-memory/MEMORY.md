...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: dogfood collision cleanup erased concurrent work and its fix is awaiting review; cancel-state and exact-diff-hash tooling gaps are open; mid-task reload and active-tool-lease grammar parity remain tracked)
