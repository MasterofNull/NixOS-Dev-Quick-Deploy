...
## Issues Backlog
- Active backlog: `.agent/memory/issues-backlog.md` (latest: shared HEAD/index integration safety, local response timeout/timing evidence and legacy benchmark metrics; background-dispatch evidence and nested archive scanning remain open; Security Center rotation, local calibration and P14s microSD reboot validation remain tracked)
