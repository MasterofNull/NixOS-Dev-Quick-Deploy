...
class LocalAgentExecutor:
    ...
    def _get_system_prompt(self, agent_type: AgentType, tools: List[Dict]) -> str:
        ...
        _workflow_contract = (
            ...
            "STEP 3: read_file(<target-file>, start_line=<fix-region-start>, end_line=<fix-region-end>)\n"
            "        Use start_line/end_line from the issue description. Read only the lines to change.\n"
            "        Then write_file to implement exactly the fix described in the issue.\n"
