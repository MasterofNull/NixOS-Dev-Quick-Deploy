...
class LocalAgentExecutor:
    ...
    def _get_system_prompt(self, agent_type: AgentType, tools: List[Dict]) -> str:
        ...
        _workflow_contract = (
            ...
            "  EXCEPTION: if the next step is write_file, you MUST read the FULL file first (no start_line/end_line).\n"
            ...
            "STEP 3: read_file(<target-file>)  ← NO start_line/end_line. Read the FULL file.\n"
            "        write_file replaces the ENTIRE file. You must have the full content in context\n"
            "        before calling write_file, or you will silently destroy unread lines.\n"
            "        Call write_file with the complete modified file content.\n"
