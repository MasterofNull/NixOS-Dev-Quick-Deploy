...
**TLS Note:** If nginx is enabled, use `https://localhost:8443` for AIDB/Hybrid/Qdrant and add `-k` for the self-signed cert.
...
⚙️  Configuration:
  qdrant_url                   : https://localhost:8443/qdrant
...
curl -k https://localhost:8443/qdrant/healthz  # Qdrant
