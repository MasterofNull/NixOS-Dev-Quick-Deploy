...
- [x] Migrated bootstrap/init/migrate/proxy wrappers:
  ...
  - `scripts/data/`: `bootstrap-prsi-confidence-samples.sh`, `bootstrap_aidb_data.sh`, `rebuild-qdrant-collections.sh`, `migrate-reports-to-database.sh`
...
- `bash -n scripts/ai/complete-via-ralph.sh scripts/deploy/{deploy-aidb-mcp-server.sh,quick-deploy-fast-verify.sh} scripts/data/{bootstrap-prsi-confidence-samples.sh,bootstrap_aidb_data.sh,rebuild-qdrant-collections.sh,migrate-reports-to-database.sh} scripts/governance/preflight-auto-remediate.sh` → PASS
