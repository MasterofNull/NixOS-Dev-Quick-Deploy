...
**Questions?** See [`docs/archive/root-docs/CONTINUE-EXTENSION-HANG-FIX.md`](docs/archive/root-docs/CONTINUE-EXTENSION-HANG-FIX.md) for complete troubleshooting guide.
