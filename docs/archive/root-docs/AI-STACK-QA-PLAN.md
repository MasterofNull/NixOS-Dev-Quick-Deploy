...
- [x] **11.4.3** Document the portability workflow in `docs/archive/root-docs/AI-STACK-QA-PLAN.md` and `docs/archive/root-docs/KNOWN_ISSUES_TROUBLESHOOTING.md`. <!-- PASS: workflow documented in 11.3.1 classification comment + script headers -->
