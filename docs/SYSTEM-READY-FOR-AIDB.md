...
**Full details**: [CONTAINER-DATA-LOSS-FIX.md](/docs/archive/CONTAINER-DATA-LOSS-FIX.md)
...
5. **Verify database integrity**: See [CONTAINER-DATA-LOSS-FIX.md](/docs/archive/CONTAINER-DATA-LOSS-FIX.md)
