...
configuration so the resulting system matches the installer defaults.【F:nixos-quick-deploy.sh†L3833-L3853】
...
warning and fabricating a temporary password.【F:nixos-quick-deploy.sh†L3855-L3876】
