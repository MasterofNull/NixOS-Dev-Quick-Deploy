...
# Import from domain subpackages so patch.object targets the real module,
# not the root-level backward-compat shim (shims don't re-export private attrs).
import core.route_handler as route_handler
import core.task_classifier as task_classifier
